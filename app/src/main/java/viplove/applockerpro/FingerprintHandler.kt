...
class FingerprintHandler(private val context: Context, private val mPackageName: String) :
    ...
    fun onAuthenticationFailed() {
        (context as LockActivity).fingerprint_icon.setImageResource(R.drawable.ic_fingerprint_accent)
